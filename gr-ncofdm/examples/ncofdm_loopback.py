...
# Generated: Sat Nov  7 18:32:34 2015
##################################################
...
class ncofdm_loopback(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._ncofdm_amp_counter.setRange(0, 0.5, 0.01)
        ...
        self._ncofdm_amp_slider.setRange(0, 0.5, 0.01)
        ...
        self.ncofdm_add_cp_sync_0 = ncofdm.add_cp_sync(fft_len, cp_len, 15, 5120, ShSeqLen, ShSeqRep, ShSymbols, LgSeqLen, LgSymbols, "packet_len")
        ...
        self.digital_ofdm_serializer_vcc_0 = digital.ofdm_serializer_vcc(fft_len, occupied_carriers, "", "", 0, "", True)
        ...
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vcc(([ncofdm_amp]*fft_len))
        ...
        self.blocks_file_sink_1_0_0_0_0 = blocks.file_sink(gr.sizeof_gr_complex*1, "/root/decdata.dat", False)
        ...
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.fft_vxx_1, 0))    
        self.connect((self.blocks_multiply_const_vxx_0, 0), (self.ncofdm_add_cp_sync_0, 0))    
        ...
        self.connect((self.digital_chunks_to_symbols_xx_0_0_0, 0), (self.blocks_file_sink_1_0_0_0_0, 0))    
        self.connect((self.digital_chunks_to_symbols_xx_0_0_0, 0), (self.ncofdm_ncofdm_carrier_allocator_0, 0))    
        self.connect((self.digital_ofdm_serializer_vcc_0, 0), (self.blocks_null_sink_1_0, 0))    
        self.connect((self.fft_vxx_0, 0), (self.blocks_multiply_const_vxx_0, 0))    
        self.connect((self.fft_vxx_1, 0), (self.digital_ofdm_serializer_vcc_0, 0))    
        ...
        self.connect((self.ncofdm_add_cp_sync_0, 0), (self.blocks_throttle_0_0, 0))    
        self.connect((self.ncofdm_ncofdm_carrier_allocator_0, 0), (self.fft_vxx_0, 0))    
        self.connect((self.ncofdm_stream2fftvector_0, 0), (self.blocks_vector_to_stream_0, 0))    
    ...
    def set_fft_len(self, fft_len):
        ...
        self.blocks_multiply_const_vxx_0.set_k(([self.ncofdm_amp]*self.fft_len))
